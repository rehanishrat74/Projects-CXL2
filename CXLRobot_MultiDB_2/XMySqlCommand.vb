...
#Region " Protected Variables "
    ...
    <CLSCompliant(False)> Protected _cmd As MySqlCommand
    <CLSCompliant(False)> Protected _conn As MySqlConnection
    ...
    <CLSCompliant(False)> Protected _mysqlTransaction As MySqlTransaction
...
#Region " Public Properties "
    ...
    <CLSCompliant(False)> Public ReadOnly Property _Connection() As MySqlConnection
        Get
            Return _conn
        End Get
    ...
    <CLSCompliant(False)> Public Property _Transaction() As MySqlTransaction
        Get
