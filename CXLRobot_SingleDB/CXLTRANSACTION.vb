...
#Region "...................Functions...................."
        ...
        Optional ByVal callsCentre As String = "0")
            ...
            'Dim CXLOBJSECURE As New com.infinilogic.gateway.CXLService
            ...
            Try
                ...
                'Obj = CXL.CXLProcessing("7475", "123", "4", "826", "2", "7475", "10", "REFUND", "1/1/2005", "12/12/2006", "CType", "TEST", Resp, Msg, "TEST ACCOUNT", "STREAMLINE", 12345678, "26", "7576", "mine")
                ...
                Else
                    If (SecurityCode = "") Then
                        'Obj = CXLOBJ.CXLProcessing(CreditCardNo, IssueNumber, TransactionAmount, GCode, MerchantId, CID, OrderID, TransactionType, S_date, C_expire, CardType, Mode, Response, Message, AgentName, AgentAcquirer, rid, MerchantLoginId, CustomerLoginId, Sender, hn, zp, CardName, callsCentre)
                    ...
                    Else
                        If (Len(SecurityCode = 4) And UCase(CardType) = "AMEX CARD") Then
                            'Obj = CXLOBJ.CXLProcessing(CreditCardNo, IssueNumber, TransactionAmount, GCode, MerchantId, CID, OrderID, TransactionType, S_date, C_expire, CardType, Mode, Response, Message, AgentName, AgentAcquirer, rid, MerchantLoginId, CustomerLoginId, Sender, SecurityCode, hn, zp, CardName, callsCentre)
        ...
        Public Function RestrictedOrders(ByVal Mid As Integer, ByVal Product_code As String, ByVal card_no As String) As DataSet
            ...
            End Try
        End Function
        Public Function MPI_ResselerAndActivationData(ByVal order_id As Integer, ByVal merchant_id As Integer, ByVal MLoginID As Integer, ByVal customerID As Integer, ByVal isOrderSuccess As String, ByVal paystatus As String, ByVal paymode As String, ByVal sender As String)
