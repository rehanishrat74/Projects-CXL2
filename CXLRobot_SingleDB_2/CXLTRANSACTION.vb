...
#Region "..................Procedures...................."
            ...
            Try
                ...
                If MPI_Session <> "" Then
                    ...
                    If CInt(CxlCode) >= 0 Then
                        UpdateStatusFor3DSecurity(MPI_Session, CInt(OrderID), CInt(CxlCode), CxlMsg)
                    Else
                        UpdateStatusFor3DSecurity(MPI_Session, CInt(OrderID), CInt(ResponseCode_Cs), Cs_MSG)
                    End If
                End If
                '////////////////////////////////////////////////////
        ...
        Public Function GetTrackFromMledger_New(ByVal track_id As Integer) As DataSet
            ...
            Catch ex As Exception
                Except = "GetTrackFromMledger Method : " & ex.Message
            Finally
                cmd = Nothing
            End Try
        End Function
        ...
        Public Sub UpdatePaymentProcessor(ByVal Trackid As Integer, ByVal PaymentProcessr As String)
            ...
            End Try
        End Sub
        Public Sub UpdateTrackidInPro_invoiceForPRO(ByVal MerchantId As String, ByVal CustLoginId As String, ByVal Trackid As Integer, ByVal inv_no As String) ', ByVal Db As String)
            ...
            Try
                ...
                'cmd.AddParameter("@Dbname", GetDBName(MerchantId))
        ...
        Public Sub UpDatePayAmount(ByVal MerchantId As String, ByVal OrderID As Integer, ByVal PaidAmount As Double, ByVal CC_Status As String)
            ...
            Try
                ...
                '     cmd.CmdText = "M" & MerchantId & ".dbo.INFINISHOPS_ORDER_UPDATE_PAYAMOUNT_ORDER_STATUS"
        ...
        Public Sub UpdateCreditCardDetailAndCXLMsgInInvoice(ByVal MerchantID As String, ByVal CustomerID As String, ByVal CXL_Digit As String, ByVal cardno As String, ByVal cardnam As String, ByVal cardtype As String, ByVal CardExpiry As Date, ByVal cardaddress As String, ByVal OrderID As Integer, ByVal SecurityCode As String, ByVal StartDate As Date, ByVal EndDate As Date, ByVal IssueNumber As String, ByVal Key As String, ByVal CurrencyCode As String, ByVal GenericCode As String, ByVal Account As String)
            ...
            End Try
        End Sub
        Public Sub UpdateCreditCardDetailInInvoice(ByVal MerchantID As String, ByVal CustomerID As String, ByVal cardno As String, ByVal cardnam As String, ByVal cardtype As String, ByVal CardExpiry As Date, ByVal cardaddress As String, ByVal OrderID As Integer, ByVal SecurityCode As String, ByVal StartDate As Date, ByVal EndDate As Date, ByVal IssueNumber As String, ByVal Key As String)
            ...
            Try
                ...
                cmd.CmdText = "CXLROBO_UpdateCreditCardDetailsInInvoice"
                cmd.Execute(ExecutionType.ExecuteNonQuery)

            Catch ex As Exception
                Except = "UpdateCreditCardDetailInInvoice Method : " & ex.Message
            Finally
                cmd = Nothing
            End Try
        End Sub
        ...
        Public Sub UpdateCreditCard(ByVal MerchantID As String, ByVal rid As Long, ByVal CxlMessage As String, ByVal TranStatus As String)
            ...
            End Try
        End Sub
        Public Sub UpdateCustomerType(ByVal Cust_id As String, ByVal m_id As String) ', ByVal Db As String)

            ' For making connection to customer server_name and its DBGATEWAY
            ' Dim cmd As New CommandData(Cust_id, 1)    ----Comment by Saad on 01/01/08
            Dim cmd As New CommandData(m_id) '----Add by Saad on 01/01/08

            Try

                cmd.AddParameter("@Customer_id", Cust_id)
                cmd.AddParameter("@Midentity", m_id)
                ' cmd.AddParameter("@Dbname", GetDBName(m_id))
        ...
        Public Sub UpdateInvoiceStatus(ByVal MerchantID As String, ByVal rid As Long, ByVal InvoiceStatus As String, ByVal CXLResponse As String, ByVal CxlMessage As String, ByVal PaymentMode As String, ByVal OrderID As Integer)
            ...
            Try
                ...
                If UCase(PaymentMode) = "CD" Then cmd.AddParameter("@CXLMessage", "Cash On Delivery") Else cmd.AddParameter("@CXLMessage", CxlMessage)
        ...
        Public Function GetMerchantRefferalOrder(ByVal MID As Integer, ByVal customer_id As Integer, ByVal order_id As Integer) As DataSet
            ...
            Try
                ...
                '---------------------------------------------------------------------
            Catch ex As Exception
                Except = "GetMerchantRefferalOrder Method : " & ex.Message
            Finally
                cmd = Nothing
            End Try
        ...
        Public Sub InsertMySqlDataInSqlServer(ByVal Cloginid As String, ByVal orderbooked As Integer, ByVal Amount As Double, ByVal requesttime As String, ByVal Timestamp1 As String, ByVal status As String, ByVal cardno As String, ByVal cardtype As String, ByVal cardname As String, ByVal cardaddress As String, ByVal cardexpire As Date, ByVal securitycode As String, ByVal issueno As String, ByVal processtype As String, ByVal genericcode As String, ByVal currencycode As String, ByVal StartDate As Date, ByVal Trackid As Integer, ByVal createinvoice As String, ByVal nocxl As Integer, ByVal authorize As Integer)
            ...
            Dim cmd As New CommandData(2, 1)  '--- Added by Saad on 02/01/08
        ...
        Public Sub UpDateInvoiceNoInCledger(ByVal Mid As String, ByVal o_id As Integer, ByVal Rid As Integer, ByVal InvNo As Double) ', ByVal db As String)
            ...
            Try
                ...
                'cmd.AddParameter("@Dbname", GetDBName(Mid))
        ...
        Public Sub OrderAddDetail(ByVal Mid As String, ByVal o_id As Integer, ByVal OrderNo As String, ByVal Prod_id As Integer, ByVal Prod_code As String, ByVal Qty As Double, ByVal Amount As Double, ByVal Tax As String, ByVal Rate As Double, ByVal UnitPrice As Double, ByVal Inv_Type As String)
            ...
            Try
                cmd.AddParameter("@MIdentity", Mid) 'Added by Saad 10/01/08
        ...
        Public Sub SrvOrderAddDetail(ByVal Mid As String, ByVal o_id As Integer, ByVal OrderNo As String, ByVal Prod_id As Integer, ByVal Prod_code As String, ByVal Qty As Double, ByVal Amount As Double, ByVal Tax As String, ByVal Rate As Double, ByVal UnitPrice As Double, ByVal Inv_Type As String)
            ...
            Try
                ...
                '     cmd.CmdText = "M" & Mid & ".dbo.INFINISHOPS_ORDER_ADDDETAILS"
                cmd.CmdText = "INFINISHOPS_ORDER_ADDDETAILS_SRV"
                cmd.Execute(ExecutionType.ExecuteNonQuery)

            Catch ex As Exception
                Except = "SrvOrderAddDetail Method : " & ex.Message
        ...
        Public Function GetOriginalSender(ByVal M As Integer, ByVal Trackid As Integer) As String
            ...
            Try
                ...
                cmd.AddParameter("@Rid", Trackid)
                'cmd.AddParameter("@Dbname", GetDBName(M))
        ...
        Public Function IsRuleBlockbyM2_New(ByVal Curr_Merchant As Integer) As DataSet
            ...
            Try
                ...
                cmd.CmdText = "DBSERVER.CXLTRANSACTION.dbo.CXLROBO_CHECKBLOCKRULEPRESENT" 'copy to cxltransaction on 21/05/09 
        ...
        Public Function IsRuleBlockbyM2(ByVal Curr_Merchant As Integer) As DataSet
            ...
            Try
                ...
                cmd.CmdText = "CXLROBO_CHECKBLOCKRULEPRESENT" 'copy to cxltransaction on 21/05/09 
                'cmd.CmdText = "CXLROBO_CHECKBLOCKRULEPRESENT"
        ...
        Public Sub InsertEmailData(ByVal mFrom As String, ByVal mTo As String, ByVal mSubject As String, ByVal mBody As String, ByVal strBCC As String, ByVal strCC As String)

            Dim cmd As New CommandData(0)

            Try
                cmd.AddParameter("@mFrom", mFrom)
                cmd.AddParameter("@mTo", mTo)
                cmd.AddParameter("@mSubject", mSubject)
                cmd.AddParameter("@mBody", mBody)
                cmd.AddParameter("@mMailFormat", 1)
                cmd.AddParameter("@strBCC", strBCC)
                cmd.AddParameter("@strCC", strCC)

                cmd.ConnectionString = PrepareConnectionSingleD()
                cmd.CmdText = "SetSendEmailResellerWebServicesForCommon"
                cmd.Execute(ExecutionType.ExecuteNonQuery)

            Catch ex As Exception
                Except = "InsertEmailData Method : " & ex.Message

            Finally
                cmd = Nothing
            End Try
        End Sub
        Public Function PrepareConnectionSingleD() As String
            Dim sqlUserID, sqlPassword, sqlDataSource, dataBaseName As String
            dataBaseName = "CONSOLIDATED1"
            ...
            Try
                ...
                sqlDataSource = "DATACENTRE2"

                'Prepare all values and return
                PrepareConnectionSingleD = "User ID=" & sqlUserID & ";Password=" & sqlPassword & ";Data Source=" & sqlDataSource & ";Initial Catalog=" & dataBaseName
...
#Region "...................Functions...................."
        ...
        Optional ByVal callsCentre As String = "0")


            Dim ds As DataSet
            Dim RealTimeProcess_Status As String = String.Empty
            Dim CxlUid, CxlPwd, CxlServer As String

            ds = GetCXL_CodeAndMsg(OrderID, MerchantId)
            RealTimeProcess_Status = ds.Tables(0).Rows(0).Item(2).ToString()

            If RealTimeProcess_Status <> "Y" Then
                ...
                Try
                    ...
                    If MPI_SessionID <> "" Then
                        threeDSecureTransSession = MPI_SessionID
                        Obj = CXLInfini.CXLProcessing43DS(CreditCardNo, IssueNumber, TransactionAmount, GCode, MerchantId, CID, OrderID, TransactionType, S_date, C_expire, CardType, Mode, Response, Message, AgentName, AgentAcquirer, rid, MerchantLoginId, CustomerLoginId, Sender, SecurityCode, eci, xid, vts, vav, MPI_SessionID, hn, zp, CardName, callsCentre)
                    Else
                        If (SecurityCode = "") Then
                            Obj = CXLInfini.CXLProcessing(CreditCardNo, IssueNumber, TransactionAmount, GCode, MerchantId, CID, OrderID, TransactionType, S_date, C_expire, CardType, Mode, Response, Message, AgentName, AgentAcquirer, rid, MerchantLoginId, CustomerLoginId, Sender, "0", hn, zp, CardName, callsCentre)
                        Else
                            If (Len(SecurityCode = 4) And UCase(CardType) = "AMEX CARD") Then
                                Obj = CXLInfini.CXLProcessing(CreditCardNo, IssueNumber, TransactionAmount, GCode, MerchantId, CID, OrderID, TransactionType, S_date, C_expire, CardType, Mode, Response, Message, AgentName, AgentAcquirer, rid, MerchantLoginId, CustomerLoginId, Sender, SecurityCode, hn, zp, CardName, callsCentre)
                            ...
                            Else
                                Response = "05"
                                Message = "Wrong SecurityCard Length"
                            End If
                        End If
                    End If
                ...
                End Try
            Else
                Response = ds.Tables(0).Rows(0).Item(0).ToString()
                Message = ds.Tables(0).Rows(0).Item(1).ToString()
            End If
        End Sub

        Private Sub cxlLog(ByVal strText As String)
            Dim folderPath As String = "C:\Cxl\Variables.txt"
            Dim sw As System.IO.StreamWriter
            sw = System.IO.File.AppendText(folderPath)
            sw.WriteLine(Now & " -- " & strText)
            sw.Close()
        ...
        Public Function GetCXL_CodeAndMsg(ByVal order_id As Integer, ByVal MerchantId As Integer) As DataSet
            Dim cmd As New CommandData

            Try
                cmd.AddParameter("@orderbooked", order_id)
                cmd.AddParameter("@mid", MerchantId)
                cmd.CmdText = "DBSERVER.CXLTransaction.dbo.CXLROBO_GETCXL_CODEANDMSG"
                Return cmd.Execute(ExecutionType.ExecuteDataSet)
            Catch ex As Exception
        ...
        Public Function CheckingValidityOfCallcentre_New(ByVal order_id As Integer, ByVal MerchantId As Integer, Optional ByVal response_code As String = "0") As DataSet
            ...
            End Try
        End Function
        Public Function CheckingValidityOfCallcentreByVal(ByVal order_id As Integer, ByVal MerchantId As Integer, Optional ByVal response_code As String = "0") As DataSet
            Dim cmd As New CommandData(-1)
            ...
            Try
                ...
                CheckingValidityOfCallcentreByVal = cmd.Execute(ExecutionType.ExecuteDataSet)
            Catch ex As Exception
                Except = "CheckingValidityOfCallcentre_New Method : " & ex.Message
                cmd = Nothing
            Finally
                cmd = Nothing
            End Try
        ...
        Public Sub GETRESPONSEFROMPAYPAL(ByVal PaypalId As String, ByVal PaypalPassword As String, ByVal Environment As String, ByVal CreditCardNo As String, ByVal CardType As String, ByVal SecurityCode As String, ByVal CardExpiry As String, ByVal TotalAmount As String, ByVal MoneyType As String, ByVal MId As String, ByVal OID As String, ByVal Rid As String, ByRef Code As String, ByRef Response As String, ByVal customer_id As String)
            ...
            Try
                ...
                'Commented following code by Saad on request of Greesh on 11/12/2009
                ...
                dsPayPal = GETPayPalCustomerInfo(MId, customer_id)

                If Not dsPayPal Is Nothing Then
                    If dsPayPal.Tables(0).Rows.Count > 0 Then
                        PAYPALOBJ.MakeTransaction_Overleaded(Trim(PaypalId), Trim(PaypalPassword), Environment, CreditCardNo, GetCardEquivalentNumber(CardType), SecurityCode, CStr(EndMonth), CStr(EndYear), TotalAmount, MoneyType, InvoiceID, Code, Response, dsPayPal.Tables(0).Rows(0).Item("Firstname"), dsPayPal.Tables(0).Rows(0).Item("lastname"), dsPayPal.Tables(0).Rows(0).Item("town"), dsPayPal.Tables(0).Rows(0).Item("street"), dsPayPal.Tables(0).Rows(0).Item("state"), dsPayPal.Tables(0).Rows(0).Item("postcode"), dsPayPal.Tables(0).Rows(0).Item("country"))
                    End If
                End If
        ...
        Public Function GETDataFromDB_New(ByVal Identity As String) As DataSet
            ...
            Try
                ...
                cmd.CmdText = "DBSERVER.CXLTRANSACTION.dbo.CXLROBO_FETCHDATA_SDB"
                Return cmd.Execute(ExecutionType.ExecuteDataSet)
            Catch ex As Exception
            ...
            End Try
        End Function
        Public Function GETPayPalCustomerInfo(ByVal merchant_id As String, ByVal customer_id As String) As DataSet
            Dim cmd As New CommandData(merchant_id)
            Try
                cmd.AddParameter("@CustomerID", customer_id)
                cmd.AddParameter("@Mid", merchant_id)

                cmd.CmdText = "PayPal_GetCustomerInfo"
                cmd.CmdType = CommandType.StoredProcedure
                Return cmd.Execute(ExecutionType.ExecuteDataSet)
            Catch ex As Exception
                Except = "GETPayPalCustomerInfo Method : " & ex.Message
                cmd = Nothing
            Finally
                cmd = Nothing
            End Try
        ...
        Public Function GETDataFromDB(ByVal Identity As String) As DataSet
            ...
            Try
                ...
                Return cmd.Execute(ExecutionType.ExecuteDataSet)
            Catch ex As Exception
                Except = "GETDataFromDB_New Method : " & ex.Message
                cmd = Nothing
            Finally
                cmd = Nothing
            End Try
        ...
        Public Function GetRidFromCS(ByVal ac As String, ByVal CustID As String, ByVal MerchantId As String, ByVal formateddate2 As String, ByVal Amount As Double, ByVal invoiceDetail As String, ByVal Invoice As String, ByVal formateddate1 As String, ByVal invoiceStatus As String, ByVal OrderID As Integer, ByVal paymentmode As String, ByVal sCompanyName As String, ByVal Rid As String, ByVal del_add As String, ByVal InvoiceStat As String, ByVal Sender As String, ByVal TranMode As String, ByVal GCode As String, ByVal CCode As String, ByVal Symbol As String) As DataSet
            ...
            End Try
        End Function
        Public Function BlockTrackID(ByVal MerchantId As String, ByVal trackID As String, ByVal status As String) As DataSet
        ...
        End Function
        '(SZ:RC)
        Public Sub UpdateStatusAsDeclinedOnRetry_New(ByVal order_id As Integer, ByVal MerchantId As Integer, ByVal cxlIdentity As Integer, Optional ByVal response_code As String = "0", Optional ByVal csmessage As String = "")
            Dim cmd As New CommandData
            Try
                cmd.AddParameter("@orderbooked", order_id)
                cmd.AddParameter("@mid", MerchantId)
            ...
            End Try
        End Sub
        Public Sub UpdateStatusAsDeclinedOnRetry(ByVal order_id As Integer, ByVal MerchantId As Integer, ByVal cxlIdentity As Integer, Optional ByVal response_code As String = "0", Optional ByVal csmessage As String = "")
            Dim cmd As New CommandData(-1)
            cmd.CmdText = "SET XACT_ABORT ON"
            cmd.CmdType = CommandType.Text
            cmd.Execute(ExecutionType.ExecuteNonQuery)
            ...
            End Try
        End Sub
        Public Function GetOrderInfo4_ProInvoice(ByVal DBName As String, ByVal MerchantId As String, ByVal Inv_no As String, ByVal CustID As String) As DataSet
        ...
        Public Function GetValidTranDrCr(ByVal Dbname As String, ByVal Rid As Long, ByVal Mid As String) As DataTable
            Dim cmd As New CommandData(Mid)
            Try
                'cmd.AddParameter("@DBName", Dbname)
        ...
        Public Function GetDBName(ByVal M_ID As String) As String
            ...
            Try
                ...
                cmd.CmdText = "DBSERVER.CXLTRANSACTION.dbo.CXLROBO_GETDBNAME"
                Dim Ds As DataSet = cmd.Execute(ExecutionType.ExecuteDataSet)
        ...
        Public Sub MPI_ResselerAndActivationData(ByVal order_id As Integer, ByVal merchant_id As Integer, ByVal MLoginID As Integer, ByVal customerID As Integer, ByVal isOrderSuccess As String, ByVal paystatus As String, ByVal paymode As String, ByVal sender As String)
            ...
            End Try
        End Sub
        Public Function RestrictedOrdersMerchant(ByVal Mid As Integer, ByVal Product_code As String, ByVal card_no As String) As DataSet
            ...
            Try
                ...
                cmd.CmdText = "CXLROBO_RESTRICT_ORDER_MERCHANT"
                Return cmd.Execute(ExecutionType.ExecuteDataSet)

            Catch ex As Exception
                Except = "RestrictedOrdersMerchant Method : " & ex.Message
                cmd = Nothing
            Finally
                cmd = Nothing
            End Try
        End Function
        Public Function RestrictedOrdersCXLT(ByVal Mid As Integer, ByVal Product_code As String, ByVal card_no As String) As DataSet
            ...
            Try
                ...
                cmd.CmdText = "CXLROBO_RESTRICT_ORDER_CXLT"
                Return cmd.Execute(ExecutionType.ExecuteDataSet)

            Catch ex As Exception
                Except = "RestrictedOrdersCXLT Method : " & ex.Message
                cmd = Nothing
            Finally
                cmd = Nothing
            End Try
        ...
        Public Sub UpdateE_CardInSQLServer(ByVal Order As String, ByVal ECard As String, ByVal TimeStamp1 As String, Optional ByVal EIssueNum As String = "", Optional ByVal ESecurityCode As String = "")
            ...
            Try
                ...
                cmd.Execute(ExecutionType.ExecuteNonQuery)
            Catch ex As Exception
                Except = "UpdateE_CardInSQLServer_New Method : " & ex.Message
                cmd = Nothing
            Finally
                cmd = Nothing
            End Try
        ...
        Public Function GetCallBackInfo(ByVal MIdentity As Int64, ByVal OrderID As Int64, ByRef IsCallBackAllowed As Boolean) As DataSet
            ...
            End Try
        End Function
        'Created by M. GREESH KUMAR on 05 MAY 2012
        Public Function GetMTS_OverDuesChargesRows(ByVal MIdentity As Int64, ByVal OrderID As Int64) As DataSet
            Dim cmd As New CommandData(MIdentity)

            Try
                cmd.CmdText = "MTS_GetOverduesChargesRows"
                cmd.AddParameter("@MIDENTITY", MIdentity)
                cmd.AddParameter("@ORDERID", OrderID)
                Dim ds As DataSet = cmd.Execute(ExecutionType.ExecuteDataSet)
                Return ds
            Catch ex As Exception
                Except = "GetMTS_OverDuesChargesRows: " & ex.Message
                cmd = Nothing
            Finally
                cmd = Nothing
            End Try
        ...
        Public Function UpdateStatusMTS_OverDuesCharges_reference(ByVal MIdentity As Int64, ByVal OrderID As Int64)
            Dim cmd As New CommandData(MIdentity)
            ...
            Try
                ...
                cmd.AddParameter("@MIDENTITY", MIdentity)
                cmd.AddParameter("@ORDERID", OrderID)
                Dim dstMTS_OverDues As DataSet = cmd.Execute(ExecutionType.ExecuteDataSet)
                ...
                If Not dstMTS_OverDues Is Nothing AndAlso dstMTS_OverDues.Tables.Count > 0 AndAlso dstMTS_OverDues.Tables(0).Rows.Count > 0 Then
                    For i As Integer = 0 To dstMTS_OverDues.Tables(0).Rows.Count - 1
                        ApprovedForTwentyPercent(dstMTS_OverDues.Tables(0).Rows(i)("MTSInvoiceRef").Split("-")(0), dstMTS_OverDues.Tables(0).Rows(i)("MTSInvoiceRef").Split("-")(2), OrderID, MIdentity, dstMTS_OverDues.Tables(0).Rows(i)("OrverduesCharges"))
                    Next
                End If
            Catch ex As Exception
                Except = "UpdateStatusMTS_OverDuesCharges_reference: " & ex.Message
                cmd = Nothing
            Finally
                cmd = Nothing
            End Try
        ...
        Public Function UpdateStatusMTS_LenderORder(ByVal MIdentity As Int64, ByVal OrderID As Int64, ByVal invoiceno As Integer, ByVal Trackid As Integer)
            Dim cmd As New CommandData(MIdentity)

            Try
                cmd.CmdText = "UpdateStatusMTS_LenderORder"
                cmd.AddParameter("@MIDENTITY", MIdentity)
                cmd.AddParameter("@ORDERID", OrderID)
                cmd.AddParameter("@invoiceno", invoiceno)
                cmd.AddParameter("@Trackid", Trackid)
                cmd.Execute(ExecutionType.ExecuteNonQuery)

            Catch ex As Exception
                Except = "UpdateStatusMTS_LenderORder: " & ex.Message
                cmd = Nothing
            Finally
                cmd = Nothing
            End Try
        End Function
        Public Function MTS_CXL_Get_Approved_PurchaseORder(ByVal MIdentity As Int64, ByVal OrderID As Int64, ByVal Amount As Double, ByVal TrackID As Integer)
            Dim cmd As New CommandData(MIdentity)

            Try
                cmd.CmdText = "MTS_CXL_Get_Approved_PurchaseORder"
                cmd.AddParameter("@MIDENTITY", MIdentity)
                cmd.AddParameter("@ORDERID", OrderID)
                Dim ds As DataSet = cmd.Execute(ExecutionType.ExecuteDataSet)
                ...
                If Not ds Is Nothing AndAlso ds.Tables(0).Rows.Count > 0 Then
                    For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                        ApprovedPurchaseORder(ds.Tables(0).Rows(i)("PurchaseOrderRefNo").Split("-")(0), ds.Tables(0).Rows(i)("PurchaseOrderRefNo").Split("-")(1), OrderID, MIdentity, Amount, TrackID, ds.Tables(0).Rows(i)("PurchaseOrderRequest_Approved_Percent"))
                    Next
                End If
            Catch ex As Exception
                Except = "MTS_CXL_Get_Approved_PurchaseORder: " & ex.Message
                cmd = Nothing
            Finally
                cmd = Nothing
            End Try
        ...
        Private Function ApprovedPurchaseORder(ByVal PurchaseOrderMid As Integer, ByVal PurchaseOrderNo As Integer, ByVal ORderID As Integer, ByVal Midentity As Integer, ByVal Amount As Double, ByVal TrackID As Integer, ByVal ApprovedPercent As String)
            Dim cmd As New CommandData(Midentity)

            Try
                cmd.CmdText = "MTS_Update_ApprovedPurchaseORder"
                cmd.AddParameter("@PurchaseOrderMid", PurchaseOrderMid)
                cmd.AddParameter("@PurchaseOrderNo", PurchaseOrderNo)
                cmd.AddParameter("@MIDENTITY", Midentity)
                cmd.AddParameter("@ORDERID", ORderID)
                cmd.AddParameter("@Amount", Amount)
                cmd.AddParameter("@TrackID", TrackID)
                cmd.AddParameter("@ApprovedPercent", ApprovedPercent)
                cmd.Execute(ExecutionType.ExecuteNonQuery)


            Catch ex As Exception
                Except = "ApprovedPurchaseORder Method : " & ex.Message
                cmd = Nothing
            Finally
                cmd = Nothing
            End Try
        End Function
        Private Function ApprovedForTwentyPercent(ByVal MTSMIdentity As Integer, ByVal MTSInvoiceNo As Integer, ByVal ORderID As Integer, ByVal Midentity As Integer, ByVal OrverduesCharges As Double)
            Dim cmd As New CommandData(Midentity)

            Try
                cmd.CmdText = "MTS_ApprovedForTwentyPercent"
                cmd.AddParameter("@MTSMIdentity", MTSMIdentity)
                cmd.AddParameter("@MTSInvoiceNo", MTSInvoiceNo)
                cmd.AddParameter("@MIDENTITY", Midentity)
                cmd.AddParameter("@ORDERID", ORderID)
                cmd.AddParameter("@OrverduesCharges", OrverduesCharges)
                cmd.Execute(ExecutionType.ExecuteNonQuery)


            Catch ex As Exception
                Except = "ApprovedForTwentyPercent Method : " & ex.Message
                cmd = Nothing
            Finally
                cmd = Nothing
            End Try
        End Function
        Public Sub OrderAddDetailForMTS(ByVal Mid As String, ByVal o_id As Integer, ByVal OrderNo As String, ByVal Prod_id As Integer, ByVal Prod_code As String, ByVal Qty As Double, ByVal Amount As Double, ByVal Tax As String, ByVal Rate As Double, ByVal UnitPrice As Double, ByVal Inv_Type As String, ByVal MTSInvoiceRef As String)
            ...
            Try
                ...
                cmd.AddParameter("@UnitPrice", UnitPrice)
                cmd.AddParameter("@inv_type", Inv_Type)
                cmd.AddParameter("@MTSInvoiceRef", MTSInvoiceRef)
                '     cmd.CmdText = "M" & Mid & ".dbo.INFINISHOPS_ORDER_ADDDETAILS"
                cmd.CmdText = "INFINISHOPS_ORDER_ADDDETAILSForMTS"
                cmd.Execute(ExecutionType.ExecuteNonQuery)

            Catch ex As Exception
                Except = "OrderAddDetailForMTS  Method : " & ex.Message
...
#Region ".................... MYSQL Functions........................"
        ...
        Public Sub UpdateMySqlData(ByVal strQuery As String)
...
#End Region
        ...
        'Public Function CheckInvoiceExist(ByVal MerchantID As Integer, ByVal OrderID As String, ByVal DbName As String) As Integer

        '    Dim cmd As New CommandData(MerchantID, 1)

        '    cmd.CmdText = "CXLROBO_CHECK_INVOICE_ALREADYEXIST"
        '    cmd.CmdType = CommandType.StoredProcedure

        '    cmd.AddParameter("@OrderID", OrderID)
        '    cmd.AddParameter("@DbName", DbName)
        '    Return cmd.Execute(ExecutionType.ExecuteScalar)
