...
'
Namespace com.infinilogic.gateway
    ...
    Public Class CXLService
        ...
        Public Sub New()
            MyBase.New
            Me.Url = "http://gateway.infinilogic.com/CXLService.asmx"
        End Sub
        ...
        Public Overloads Function CXLProcessing( _
                    ...
                    ByVal sender As String) As Object
            Dim results() As Object = Me.Invoke("CXLProcessing", New Object() {CreditCardNO, IssueNumber, TransactionAmount, GCode, MerchantId, CID, OrderID, TransactionType, StartDate, CardExpiry, CardType, Mode, CXLResponseCode, CXLMessage, agentName, agentAcquirer, rid, merchantloginid, customerloginid, sender})
        ...
        Public Function BeginCXLProcessing( _
            ...
            Return Me.BeginInvoke("CXLProcessing", New Object() {CreditCardNO, IssueNumber, TransactionAmount, GCode, MerchantId, CID, OrderID, TransactionType, StartDate, CardExpiry, CardType, Mode, CXLResponseCode, CXLMessage, agentName, agentAcquirer, rid, merchantloginid, customerloginid, sender}, callback, asyncState)
        End Function
        ...
        Public Overloads Function CXLProcessing( _
                    ...
                    ByVal zp As String) As <System.Xml.Serialization.XmlElementAttribute("CXLProcessingUpgradeResult")> Object
            Dim results() As Object = Me.Invoke("CXLProcessing1", New Object() {CreditCardNO, IssueNumber, TransactionAmount, GCode, MerchantId, CID, OrderID, TransactionType, StartDate, CardExpiry, CardType, Mode, CXLResponseCode, CXLMessage, agentName, agentAcquirer, rid, merchantloginid, customerloginid, sender, hn, zp})
            CXLResponseCode = CType(results(1),String)
            CXLMessage = CType(results(2),String)
            Return CType(results(0),Object)
        End Function
        ...
        Public Function BeginCXLProcessing1( _
                    ...
                    ByVal callback As System.AsyncCallback,  _
                    ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("CXLProcessing1", New Object() {CreditCardNO, IssueNumber, TransactionAmount, GCode, MerchantId, CID, OrderID, TransactionType, StartDate, CardExpiry, CardType, Mode, CXLResponseCode, CXLMessage, agentName, agentAcquirer, rid, merchantloginid, customerloginid, sender, hn, zp}, callback, asyncState)
        End Function
        ...
        Public Overloads Function CXLProcessing( _
                    ...
                    ByVal customerloginid As String,  _
                    ByVal sender As String,  _
                    ByVal ccv As String) As <System.Xml.Serialization.XmlElementAttribute("CXLProcessingWithCcvResult")> Object
            Dim results() As Object = Me.Invoke("CXLProcessing2", New Object() {CreditCardNO, IssueNumber, TransactionAmount, GCode, MerchantId, CID, OrderID, TransactionType, StartDate, CardExpiry, CardType, Mode, CXLResponseCode, CXLMessage, agentName, agentAcquirer, rid, merchantloginid, customerloginid, sender, ccv})
            CXLResponseCode = CType(results(1),String)
            CXLMessage = CType(results(2),String)
            Return CType(results(0),Object)
        End Function
        ...
        Public Function BeginCXLProcessing2( _
                    ...
                    ByVal callback As System.AsyncCallback,  _
                    ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("CXLProcessing2", New Object() {CreditCardNO, IssueNumber, TransactionAmount, GCode, MerchantId, CID, OrderID, TransactionType, StartDate, CardExpiry, CardType, Mode, CXLResponseCode, CXLMessage, agentName, agentAcquirer, rid, merchantloginid, customerloginid, sender, ccv}, callback, asyncState)
        End Function
        ...
        Public Overloads Function CXLProcessing( _
                    ...
                    ByVal ccv As String,  _
                    ByVal hn As String,  _
                    ByVal zp As String) As <System.Xml.Serialization.XmlElementAttribute("CXLProcessingWithCcvUpgradeResult")> Object
            Dim results() As Object = Me.Invoke("CXLProcessing3", New Object() {CreditCardNO, IssueNumber, TransactionAmount, GCode, MerchantId, CID, OrderID, TransactionType, StartDate, CardExpiry, CardType, Mode, CXLResponseCode, CXLMessage, agentName, agentAcquirer, rid, merchantloginid, customerloginid, sender, ccv, hn, zp})
            CXLResponseCode = CType(results(1),String)
            CXLMessage = CType(results(2),String)
            Return CType(results(0),Object)
        End Function
        ...
        Public Function BeginCXLProcessing3( _
                    ...
                    ByVal callback As System.AsyncCallback,  _
                    ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("CXLProcessing3", New Object() {CreditCardNO, IssueNumber, TransactionAmount, GCode, MerchantId, CID, OrderID, TransactionType, StartDate, CardExpiry, CardType, Mode, CXLResponseCode, CXLMessage, agentName, agentAcquirer, rid, merchantloginid, customerloginid, sender, ccv, hn, zp}, callback, asyncState)
        End Function
        ...
        Public Overloads Function CXLProcessing( _
                    ...
                    ByVal hn As String,  _
                    ByVal zp As String) As <System.Xml.Serialization.XmlElementAttribute("CXLProcessingWith3dsecureResult")> Object
