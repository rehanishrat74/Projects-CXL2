...
#Region " Class Functions/Methods"
    ...
    Private Shared Function GetServerName(ByVal customerid As Integer) As String
        ...
        Try
            ...
            System.Web.HttpContext.Current.Trace.Warn("GetServerName ConnectionString:" & ConnectionString)

            Dim _conn As New SqlConnection(ConnectionString & ";Connect Timeout=" & 60) 'Old value 30
            Dim _cmd As New SqlCommand
            _conn.Open()
            _cmd.Connection = _conn
            _cmd.CommandText = "DBSERVER.infinishopmainDB.dbo.CXLROBO_GETDBNAME"
    ...
    Private Overloads Shared Function GetDataBaseName(ByVal employerID As String) As String
        ...
        Try
            ...
            Dim ConnectionString As String = PrepareConnectionString(DEFAULT_DATABASE)
            System.Web.HttpContext.Current.Trace.Warn("GetDataBaseName ConnectionString:" & ConnectionString)
    ...
    Private Shared Function PrepareConnectionString(ByVal dataBaseName As String) As String
        ...
        Try
            ...
            sqlUserID = ConfigReader.GetItem(ConfigVariables.SQLRefundUserID)
            sqlPassword = ConfigReader.GetItem(ConfigVariables.SQLRefundPassword)

            System.Web.HttpContext.Current.Trace.Warn("PrepareConnectionString :")

            System.Web.HttpContext.Current.Trace.Warn("sqlUserID :" & sqlUserID)
            System.Web.HttpContext.Current.Trace.Warn("sqlPassword :" & sqlPassword)
            System.Web.HttpContext.Current.Trace.Warn("sqlDataSource :" & sqlDataSource)
            System.Web.HttpContext.Current.Trace.Warn("sqlInitialCatalog :" & dataBaseName)

            'sqlUserID = ConfigurationSettings.AppSettings.Item("SQL_User_ID")
            'sqlPassword = ConfigurationSettings.AppSettings.Item("SQL_User_Password")
