...
#Region "..................Procedures...................."
        ...
        Public Sub InsertMySqlDataInSqlServer_New(ByVal Cloginid As String, ByVal orderbooked As Integer, ByVal Amount As Double, ByVal requesttime As String, ByVal Timestamp1 As String, ByVal status As String, ByVal cardno As String, ByVal cardtype As String, ByVal cardname As String, ByVal cardaddress As String, ByVal cardexpire As Date, ByVal securitycode As String, ByVal issueno As String, ByVal processtype As String, ByVal genericcode As String, ByVal currencycode As String, ByVal StartDate As Date, ByVal Trackid As Integer, ByVal createinvoice As String, ByVal nocxl As Integer, ByVal authorize As Integer)
            ...
            Catch ex As Exception
                Except = "InsertMySqlDataInSqlServer Method : " & ex.Message & ". spname = CXLROBO_INSERTMYSQLDATA. connection string =" & cmd.ConnectionString.ToString & ". Order id=" & orderbooked
                'MsgBox(cmd.ConnectionString)
                Throw ex
            Finally
                cmd = Nothing
            End Try
        End Sub
        Public Sub MPI_ResselerAndActivationData(ByVal order_id As Integer, ByVal merchant_id As Integer, ByVal MLoginID As Integer, ByVal customerID As Integer, ByVal isOrderSuccess As String, ByVal paystatus As String, ByVal paymode As String)
...
#Region "...................Functions...................."
        ...
        Optional ByVal callcentre As String = "0")
            ...
            Dim ds As DataSet
            Dim TNSPay_Enabled As Boolean = False
            Dim cxl_code As String = ""

            ds = Check_TNSEnabled_with_CXL_CodeAndMsg(OrderID, MerchantId)
            TNSPay_Enabled = ds.Tables(0).Rows(0).Item(2).ToString()
            cxl_code = ds.Tables(0).Rows(0).Item(0).ToString()


            If TNSPay_Enabled <> True And cxl_code <> "00" Then
        ...
        Public Function GETDataFromDB_New(ByVal Identity As String) As DataSet
            ...
            Try
                ...
                cmd.CmdText = "DBSERVER.CXLTRANSACTION.dbo.CXLROBO_FETCHDATA_MDB"
                Return cmd.Execute(ExecutionType.ExecuteDataSet)
            Catch ex As Exception
                Except = "GETDataFromDB Method : " & cmd.ConnectionString & "EX:" & ex.Message & "" & "Identity:" & Identity & ""
        ...
        Public Function GetOrderInfo(ByVal DBName As String, ByVal M_Id As String, ByVal OrderID As String) As DataSet
            ...
            Catch ex As Exception
                '                MsgBox(cmd.ConnectionString & "ex.message" & ex.Message)
                Except = " GetOrderInfo Method : " & ex.Message & " Connection String " & cmd.ConnectionString & " sp name =CXLROBO_GETORDERINFO. M_id=" & M_Id & ". orderid =" & OrderID
                cmd = Nothing
                Throw ex
            Finally
                cmd = Nothing
        ...
        Public Function Check_TNSEnabled_with_CXL_CodeAndMsg(ByVal order_id As Integer, ByVal MerchantId As Integer) As DataSet
            Dim cmd As New CommandData

            Try
                cmd.AddParameter("@orderbooked", order_id)
                cmd.AddParameter("@mid", MerchantId)
                cmd.CmdText = "DBSERVER.CXLTransaction.dbo.CXLROBO_GET_TNSENABLED_CXLCODEMSG"
                Return cmd.Execute(ExecutionType.ExecuteDataSet)
            Catch ex As Exception
                Except = "Check_TNSEnabled_with_CXL_CodeAndMsg Method : " & ex.Message
                cmd = Nothing
            Finally
                cmd = Nothing
            End Try
        ...
        Public Function Check_MerchantTNSPayEnabled(ByVal MerchantID As Integer) As Boolean

            Dim cmd As New CommandData
            Dim returnValue As Boolean = False
            Try
                cmd.AddParameter("@Merchant_Id", MerchantID)
                cmd.CmdText = "DBSERVER.INFINISHOPMAINDB.DBO.CXLROBO_MERCHANT_CHECK_TNSENABLED"
                Dim ds As DataSet = cmd.Execute(ExecutionType.ExecuteDataSet)
                returnValue = Convert.ToBoolean(ds.Tables(0).Rows(0).Item("TNSPay_Enabled"))
                Return returnValue
            Catch ex As Exception
                Except = "Check_MerchantTNSPayEnabled Method : " & ex.Message
                cmd = Nothing
                Return returnValue
            Finally
                cmd = Nothing
