...
Namespace com.infinishops.couponsystem
    ...
    Partial Public Class EmailCoupon
        Inherits System.Web.Services.Protocols.SoapHttpClientProtocol
        
        Private EmailToCustomerOperationCompleted As System.Threading.SendOrPostCallback
        ...
        '''<remarks/>
        Public Event EmailToCustomerCompleted As EmailToCustomerCompletedEventHandler
        ...
        '''<remarks/>
        Public Overloads Sub EmailToCustomerAsync(ByVal MerchantID As Integer, ByVal CustomerID As Integer, ByVal OrderId As Integer)
            Me.EmailToCustomerAsync(MerchantID, CustomerID, OrderId, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub EmailToCustomerAsync(ByVal MerchantID As Integer, ByVal CustomerID As Integer, ByVal OrderId As Integer, ByVal userState As Object)
            If (Me.EmailToCustomerOperationCompleted Is Nothing) Then
                Me.EmailToCustomerOperationCompleted = AddressOf Me.OnEmailToCustomerOperationCompleted
            End If
            Me.InvokeAsync("EmailToCustomer", New Object() {MerchantID, CustomerID, OrderId}, Me.EmailToCustomerOperationCompleted, userState)
        End Sub
        
        Private Sub OnEmailToCustomerOperationCompleted(ByVal arg As Object)
            If (Not (Me.EmailToCustomerCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent EmailToCustomerCompleted(Me, New EmailToCustomerCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.4927")>  _
    Public Delegate Sub EmailToCustomerCompletedEventHandler(ByVal sender As Object, ByVal e As EmailToCustomerCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.4927"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class EmailToCustomerCompletedEventArgs
